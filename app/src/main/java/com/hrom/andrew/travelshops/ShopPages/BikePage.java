...
public class BikePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chooseListUrl(list,bikeShop.getListShops(),bikeShop.getIconShops(),bikeShop);
    }

    private void chooseListUrl(ListView list, List shops, List imageShops, final SportShop sportShop) {
        CustomList adapter = new CustomList(BikePage.this, shops, imageShops);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(AdapterView<?> adapterView, View view, int i, long l, IDrawerItem iDrawerItem) {
                        if (i == 0) {
                            ...
                            Intent intent = new Intent(BikePage.this, MountainPage.class);
                            startActivity(intent);
                        } else if (i == 3) {
                            Intent intent = new Intent(BikePage.this, SkisPage.class);
                            startActivity(intent);
                        } else if (i == 4) {
                            Intent intent = new Intent(BikePage.this, SnowboardPage.class);
                            startActivity(intent);
                        } else if (i == 5) {
                            drawer.closeDrawer();
                        }
